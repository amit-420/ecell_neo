...
<title>NEO | Online test </title>
<link  rel="stylesheet" href="../public/admin/css/bootstrap.min.css"/>
 <link  rel="stylesheet" href="../public/admin/css/bootstrap-theme.min.css"/>
  ...
  <div class="modal-dialog">
    <div class="modal-content title1">
      ...
      <div class="modal-body">
        <form class="form-horizontal" action="../reglog/login.php?q=admin/index.php" method="POST">
<fieldset>
